...
<body >
	...
	<div class="container" >
<br>
<div><h1 align="center"><i>Approved Two Wheelers</i></h1></div><br>
<?php
	include 'db.php';
  ...
  <table class="table table-bordered">
		<tr><th>Track ID</th><th>Name</th><th>Roll No</th><th>Department</th><th>Bike Model</th><th>Bike No</th><th>Driving License</th><th>RC Book</th><th>Insurance</th><th>ID Card</th><th>Status</th></tr>
	<?php
	$depart=$_SESSION['department'];
$desig=$_SESSION['desig'];
if($desig=="Faculty")
{
	$sql="SELECT * FROM bike WHERE  department='$depart'  ORDER BY track_id";
	if($res=mysqli_query($con,$sql))
	{
		while($row=mysqli_fetch_array($res))
		{
			...
			?><tr><td><?php echo $row['track_id']; ?></td>
				...
				{
					?><tr><td colspan="11">Sorry,No Records Found.</td></tr><?php
				}
				}?>
			  </tr>
			<?php
	...
	{
	$sql="SELECT * FROM bike  ORDER BY track_id";
	if($res=mysqli_query($con,$sql))
	{
		while($row=mysqli_fetch_array($res))
		{
